...
class DeleteDialog extends Component {
    ...
    render(){
        ...
        return (
            ...
            <DialogComponent
                open={state}
                onClose={() => {toggler(); reset('DeleteDialog')}}
            >
                <div className="quantity_dialog">
                    ...
                    <div className="descriptions">
                        <span>You are about to delete product <span className='name'>{product_name}</span>. Enter {product_quantity} to proceed <br/></span>
                    </div>
