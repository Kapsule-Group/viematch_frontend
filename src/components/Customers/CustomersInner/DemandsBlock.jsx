...
import { getUserSubs } from './../../../actions/customersActions';
...
class DemandsBlock extends Component {
  ...
  changePage = (page) => {
    ...
    getUserSubs(id, page.selected + 1, searchValue, option && option.value);
  };
              ...
              <div className="search_info">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    getUserSubs(id, 1, value, option && option.value);
                  }}
                  value={searchValue}
                />
              </div>
          ...
          <FormControl className="select_wrapper">
            <SelectComponent
              ...
              change={(e) => {
                ...
                getUserSubs(id, 1, searchValue, e.value);
              }}
              isClearable={false}
              isSearchable={false}
            />
...
function mapStateToProps(state) {
  return {
    subs: state.customers.subs,
  };
}
function mapDispatchToProps(dispatch) {
  return bindActionCreators({ getUserSubs }, dispatch);
}
